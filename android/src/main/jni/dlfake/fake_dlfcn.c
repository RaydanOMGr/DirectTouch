...
#define log_info(fmt,args...) do { printf("[DirectTouch/" TAG_NAME "] "); printf((const char *) fmt, ##args); } while(0)
#define log_err(fmt,args...) do { printf("[DirectTouch/" TAG_NAME "] "); printf((const char *) fmt, ##args); } while(0)
